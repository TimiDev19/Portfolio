...
const nunito = Nunito({
  ...
  variable: '--font-nunito', // optional, for Tailwind integration
})
...
const page = () => {
    ...
    return (
        <div className={`${inter.className} text-white pt-[100px] px-5`}>
            <div id='ecommerce' className=' --font-montserrat mb-[40px]'>
                <h1 className=' font-bold text-5xl mb-6'>eCommerce</h1>
                <div className=" w-full">
                    {
                        ecommerce_projects.map((project, index) => (
                            <div key={index} className=" border-2 border-[#fb4566] w-[95%] lg:w-[85%] mx-auto mb-4 duration-500 flex flex-col lg:flex-row items-center justify-center cursor-pointer">
                                <Image
                                    src={project.image}
                                    alt=""
                                ...
                                <div className=' w-full lg:w-[50%] p-4'>
                                    ...
                                    <h1 className=" font-bold mt-4">{project.tech}</h1>
