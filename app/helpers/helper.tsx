...
const techstack = {
  languages: [
    ...
    },
    {
      ...
      name: "Tailwind CSS",
      about:
        "Tailwind CSS is a utility-first CSS framework for building modern websites without ever leaving your HTML.",
    },
    {
    ...
    },
    {
      ...
      name: "Vite",
      about:
        "Vite JS is majorly used to set up a development environment for various frameworks like React and Vue etc.",
    },
    {
      image: javscriptLogo,
      name: "JavaScript",
      about:
        "JS is a scripting language that enables you to create dynamically updating content, control multimedia, and so much more.",
    },
    {
      image: githublogo,
      name: "Github",
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "This is a fully funtional and responsive website for a resort allowing users to view different rooms available and also book rooms for themselves. The website also features a testimonial section allowing users to read testimonials of last customers but also add their own testimonial.",
    ...
    },
    {
      ...
      description:
        "This is a fully funtional and responsive website for Zach Tech Industries giving users an insight to the company and also showing the company in a good light to potential investors",
    ...
    // },
    {
      ...
      title: "$SLVR",
      description:
        "This is a fully funtional and responsive website for a web3 memecoin project, clearly stating various things about the project. The website features a live chart from DexScreener to ease the trading experiance and also allow users buy the token directly.",
